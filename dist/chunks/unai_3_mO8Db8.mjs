const id = "unai.md";
						...
						const slug = "libros-unai";
						const body = "";
						const data = {nome:"Unai",username:"unai",alt:"unai",image:
					...
					,punti:3};
						const _internal = {
							type: 'content',
							filePath: "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/books/src/content/concorrenti/unai.md",
