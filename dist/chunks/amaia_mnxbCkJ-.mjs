const id = "amaia.md";
						...
						const slug = "libros-amaia";
						const body = "";
						const data = {nome:"Amaia",username:"amaia",alt:"amaia",image:
					...
					,punti:35};
						const _internal = {
							type: 'content',
							filePath: "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/books/src/content/concorrenti/amaia.md",
