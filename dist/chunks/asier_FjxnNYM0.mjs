const id = "asier.md";
						...
						const slug = "libros-asier";
						const body = "";
						const data = {nome:"Asier",username:"asier",alt:"asier",image:
					...
					,punti:22};
						const _internal = {
							type: 'content',
							filePath: "/Users/alessandro-giuzio/Documents/Ale/GitHub-Repo/books/src/content/concorrenti/asier.md",
